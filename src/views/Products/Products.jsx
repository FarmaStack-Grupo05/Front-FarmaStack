		...
		<div>
          ...
          > */}
					...
					<div className="mt-8 block lg:hidden">
						...
						{isFiltersVisible && (
							<div className="space-y-4 lg:block shadow-xl h-full p-5 rounded-3xl">
								{/* Filters content */}
								<div>Sort By Name</div>
								<div>Sort By Price</div>
								<div>Filters for category</div>
							</div>
						)}
					</div>
										...
										>
											...
											>
												...
												<div className="flex flex-row cursor-pointer items-center justify-between">
													...
													<div>
														<button className="block w-auto rounded bg-yellow-400 p-2 text-sm font-medium transition hover:scale-105">
															Add to cart
														</button>
													</div>
												</div>
