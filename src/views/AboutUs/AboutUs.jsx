...
function AboutUs() {
  ...
  return (
    <div className="flex flex-wrap justify-center items-center mt-8">
      <section class="bg-#D9D9D9 dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto w-auto text-center lg:py-16 lg:px-6">
          <div class="mx-auto mb-8 w-auto lg:mb-16">
                ...
                <div class="grid gap-8 lg:gap-16 ">
                  <div class="text-center text-gray-500 dark:text-gray-400 ">
                    <img
                      ...
                      alt="Bonnie Avatar"
                    />
                    <h3 class="mb-1 text-2xl font-bold tracking-tight text-gray-700 dark:text-white">
